    ...
    return (
        <div className='container__login'>
            <form className="container__form__login" onSubmit={handleSubmit}>
                ...
                <input type="email" name="user_name" onChange={i => setUserEmail(i.target.value)} required className="form__inp" placeholder="Email hoặc Số điện thoại"></input>
                <input type="password" onChange={i => setPassword(i.target.value)} name="user_pass" required className="form__inp" placeholder="Mật khẩu"></input>
